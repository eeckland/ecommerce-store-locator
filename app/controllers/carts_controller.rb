class CartsController < ApplicationController
  ...
  def add_to_cart
	  ...
	  #using local variables, not instance ones (not available through the entire stack)
  end
  ...
  def order_complete
    @order = Order.find(params[:order_id]) #select * from Order 
    ...
    rescue Stripe::CardError => e #error object
